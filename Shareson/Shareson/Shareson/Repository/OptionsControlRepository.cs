...
{
    public class OptionsControlRepository
    {
        OptionsControlModel model = new OptionsControlModel();

        public void SaveSettings(OptionsControlModel tempModel) // options -> global settings
        {
        ...
        public OptionsControlModel LoadSettings() // global settings -> options 
        {
